...
def test_cli_runs_exposure_load_shadow_prospective_evidence_gate_from_stress_test(
    tmp_path,
    monkeypatch,
):
    stress_path = (
    ...
    stress_path.write_text("artifact", encoding="utf-8")
    calls = {}

    def fake_run_exposure_load_shadow_prospective_evidence_gate_sprint_experiment(
        exposure_load_shadow_bounded_calibration_stress_test_path,
        output_dir,
        experiment_id,
    ):
        calls["shadow_prospective_evidence_gate"] = {
            "exposure_load_shadow_bounded_calibration_stress_test_path": (
                exposure_load_shadow_bounded_calibration_stress_test_path
            ),
            "output_dir": output_dir,
    ...
    monkeypatch.setattr(
        ...
        fake_run_exposure_load_shadow_prospective_evidence_gate_sprint_experiment,
    )
    ...
    exit_code = main(
        [
            ...
            str(tmp_path),
            "--experiment-id",
            "exposure_load_shadow_prospective_evidence_gate",
            "--exposure-load-shadow-prospective-evidence-gate-sprint",
            "--exposure-load-shadow-bounded-calibration-stress-test",
            str(stress_path),
        ]
    )

    assert exit_code == 0
    assert calls["shadow_prospective_evidence_gate"] == {
...
def test_cli_runs_exposure_load_shadow_prospective_collection_operations_from_gate(
    tmp_path,
    monkeypatch,
):
    gate_path = tmp_path / "exposure_load_shadow_prospective_evidence_gate.json"
    gate_path.write_text("artifact", encoding="utf-8")
    calls = {}

    def fake_run_exposure_load_shadow_prospective_collection_operations_sprint_experiment(
        exposure_load_shadow_prospective_evidence_gate_path,
        output_dir,
        experiment_id,
    ):
        calls["shadow_prospective_collection_operations"] = {
            "exposure_load_shadow_prospective_evidence_gate_path": (
                exposure_load_shadow_prospective_evidence_gate_path
            ),
            "output_dir": output_dir,
    ...
    monkeypatch.setattr(
        ...
        fake_run_exposure_load_shadow_prospective_collection_operations_sprint_experiment,
    )
    ...
    exit_code = main(
        [
            ...
            "--exposure-load-shadow-prospective-evidence-gate",
            str(gate_path),
        ]
    )

    assert exit_code == 0
    assert calls["shadow_prospective_collection_operations"] == {
...
def test_cli_runs_exposure_load_shadow_prospective_collection_completion_from_operations(
    tmp_path,
    monkeypatch,
):
    operations_path = (
    ...
    def fake_run_exposure_load_shadow_prospective_collection_completion_sprint_experiment(
        exposure_load_shadow_prospective_collection_operations_path,
        output_dir,
        experiment_id,
    ):
        calls["shadow_prospective_collection_completion"] = {
            "exposure_load_shadow_prospective_collection_operations_path": (
                exposure_load_shadow_prospective_collection_operations_path
            ),
            "output_dir": output_dir,
    ...
    monkeypatch.setattr(
        ...
        fake_run_exposure_load_shadow_prospective_collection_completion_sprint_experiment,
    )
    ...
    exit_code = main(
        [
            ...
            str(tmp_path),
            "--experiment-id",
            "exposure_load_shadow_prospective_collection_completion",
    ...
    assert exit_code == 0
    assert calls["shadow_prospective_collection_completion"] == {
        "exposure_load_shadow_prospective_collection_operations_path": (
            operations_path
        ),
        "output_dir": tmp_path,
